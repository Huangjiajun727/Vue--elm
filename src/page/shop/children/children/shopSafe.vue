      ...
      <section>
        ...
        <section class="license_img shop_status_container">
          ...
          <div class="img_container">
            <img :src="localapi || proapi ? imgBaseUrl + shopDetail.license.business_license_image : getImgPath(shopDetail.license.business_license_image)" alt="business_license_image">
            <img :src="localapi || proapi ? imgBaseUrl + shopDetail.license.catering_service_license_image : getImgPath(shopDetail.license.catering_service_license_image)" alt="catering_service_license_image">
          </div>
        </section>
      </section>
    </section>
